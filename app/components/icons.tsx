...
function Icon({ size = 24, className, id, 'aria-label': ariaLabel, viewBox, children }: IconProps & { viewBox: string; children: React.ReactNode }) {
  return (
    <svg
...
export function FaXTwitter(props: IconProps) {
  return (
    <Icon viewBox="0 0 448 512" {...props}>
...
export function FaPatreon(props: IconProps) {
  return (
...
export function FaBluesky(props: IconProps) {
  return (
...
export function FaTumblr(props: IconProps) {
  return (
    <Icon viewBox="0 0 320 512" {...props}>
...
export function FaBagShopping(props: IconProps) {
  return (
    <Icon viewBox="0 0 448 512" {...props}>
...
export function FaUser(props: IconProps) {
  return (
    <Icon viewBox="0 0 448 512" {...props}>
...
export function FaCcVisa(props: IconProps) {
  return (
    <Icon viewBox="0 0 576 512" {...props}>
...
export function FaCcPaypal(props: IconProps) {
  return (
    <Icon viewBox="0 0 576 512" {...props}>
...
export function FaCcMastercard(props: IconProps) {
  return (
    <Icon viewBox="0 0 576 512" {...props}>
...
export function FaSpinner(props: IconProps) {
  return (
    <Icon viewBox="0 0 512 512" {...props}>
